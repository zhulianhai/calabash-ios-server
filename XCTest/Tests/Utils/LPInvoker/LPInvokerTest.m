...
- (id) returnsNil;
- (id)methodWithParam1:(id)one param2:(id)two;
...
- (id)methodWithParam1:(id)one param2:(id)two { return one; }
...
- (void) testDesignatedInitializerMultiArgs {
    NSString *target = @"string";
    SEL selector = @selector(methodWithParam1:param2:);
    LPInvoker *invoker = [[LPInvoker alloc] initWithSelector:selector
                                                      target:target];
    XCTAssertEqual(invoker.selector, selector);
    XCTAssertEqualObjects(invoker.target, target);
...
- (void) testInvocationRespondsToSelectorMultiArgs {
    NSString *target = @"string";
    SEL selector = @selector(methodWithParam1:param2:);
    LPInvoker *invoker = [[LPInvoker alloc] initWithSelector:selector
                                                      target:target];
...
- (void) testSignatureRespondsToSelectorMultiArgs {
    NSString *target = @"string";
    SEL selector = @selector(methodWithParam1:param2:);
    LPInvoker *invoker = [[LPInvoker alloc] initWithSelector:selector
                                                      target:target];
...
- (void)testNumberOfArguments2 {
    NSString *target = @"string";
    SEL selector = @selector(methodWithParam1:param2:);
    LPInvoker *invoker = [[LPInvoker alloc] initWithSelector:selector
                                                      target:target];
    XCTAssertEqual([invoker numberOfArguments], 2);
}
